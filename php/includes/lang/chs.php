...
DEFINE('_COMMON_COM发布NENT_MAINMENU','主选单');
DEFINE('_COMMON_COM发布NENT_NEWS','最新消息');
...
DEFINE('_COMMON_PARAM_EMAIL','电子邮箱');
...
DEFINE('_COMMON_PARAM_ALLRIGHT','权利声明');
...
DEFINE('_COMMON_PARAM_发布STBRANCH','分局(邮局)');
DEFINE('_COMMON_PARAM_发布STID','户名(邮局)');
DEFINE('_COMMON_PARAM_发布STNUM1','帐号一(邮局)');
DEFINE('_COMMON_PARAM_发布STNUM2','帐号二(邮局)');
...
DEFINE('_COMMON_PARAM_COU发布N','Coupon卷');
DEFINE('_COMMON_PARAM_BONUS','红利');
...
DEFINE('_COMMON_QUERYMSG_LOGIN_ERROR2','目前仅开放经销商登录');
DEFINE('_COMMON_QUERYMSG_HAVE_LOG','已有会员兑换Coupon卷，不可删除');
DEFINE('_COMMON_QUERYMSG_SIGNUP_ERROR','此帐号已是会员，请直接登录');
DEFINE('_COMMON_QUERYMSG_SIGNUP_SUC','注册成功');

DEFINE('_COMMON_ERRORMSG_NET_ERR','网络错误，请确认您的连线状态');
...
//0707购物车
DEFINE("_CART_ERROR_MSG","请先完成会费付款及邮箱验证");
...
DEFINE("_CART_PAY_SUCCESS_MSG8","客服邮箱：");
...
DEFINE("_CART_NET_ERROR_MSG","网络连线错误");
...
DEFINE("_CART_ORDER_ADD_MSG12","客服邮箱：");
...
DEFINE("_发布INTS_NOT_ENOUGH","点数不足");
...
DEFINE("_MEMBER_SID_REPEAT_MEMBER","身分证字号已注册会员");
DEFINE("_MEMBER_EMAIL_REPEAT","电子邮箱已使用过");
DEFINE("_MEMBER_SID_ERROR","无效身分证字号");
DEFINE("_MEMBER_EMAIL_ERROR","无效电子邮箱");
...
DEFINE("_MEMBER_EMAILCHK_MSG10","完成邮箱认证，您可以进行购物。");
...
DEFINE("_MEMBER_LOGIN_FIRST","请先登录");
DEFINE("_MEMBER_ENTER_PWD","请输入密码");
DEFINE("_MEMBER_ERROR_MSG","密码已更改，请使用新密码登录");
...
DEFINE("_MEMBER_EMAIL_USERD","此邮箱已被使用");
...
DEFINE("_MEMBERS_EXCEL_TITLE","会员编号,身分证号,会员姓名,通讯地址,电话,手机,户籍地址,E-mail,生日(公元年),申请书日期(完款日),上线编号,上线姓名,上线电话,上线手机,是否会员");
DEFINE("_MEMBERS_SAME_EMAIL","已存在相同的电子邮箱");
DEFINE("_MEMBERS_SAME_CARD_NO","已存在相同的经销商会员卡号");
DEFINE("_MEMBERS_SAME_NO","已存在相同的会员编号");
DEFINE("_MEMBERS_LOGOUT","注销");
DEFINE("_MEMBERS_LOGIN","登录");
...
DEFINE("_ORDER_SHIPPING_MSG13","客服邮箱：");
DEFINE("_ORDER_INVOICETYPESTR0","索取纸本收据");
DEFINE("_ORDER_INVOICETYPESTR1","捐献发票至其他单位");
DEFINE("_ORDER_INVOICETYPESTR2","不索取纸本收据");

DEFINE("_ORDER_EX发布RT_STR1","订单编号");
DEFINE("_ORDER_EX发布RT_STR2","订单日期");
DEFINE("_ORDER_EX发布RT_STR3","订单未税金额");
DEFINE("_ORDER_EX发布RT_STR4","订单含税总金额");
DEFINE("_ORDER_EX发布RT_STR5","会员编号");
DEFINE("_ORDER_EX发布RT_STR6","购买者");
DEFINE("_ORDER_EX发布RT_STR7","总PV");
DEFINE("_ORDER_EX发布RT_STR8","总BV");
DEFINE("_ORDER_EX发布RT_STR9","实际购买人");
DEFINE("_ORDER_EX发布RT_STR10","送货地址");
DEFINE("_ORDER_EX发布RT_STR11","订单单号");
DEFINE("_ORDER_EX发布RT_STR12","项次");
DEFINE("_ORDER_EX发布RT_STR13","产品编号");
DEFINE("_ORDER_EX发布RT_STR14","品名");
DEFINE("_ORDER_EX发布RT_STR15","数量");
DEFINE("_ORDER_EX发布RT_STR16","单价");
DEFINE("_ORDER_EX发布RT_STR17","未税金额");
DEFINE("_ORDER_EX发布RT_STR18","含税金额");
DEFINE("_ORDER_EX发布RT_STR19","收件者");
DEFINE("_ORDER_EX发布RT_STR20","收件人电话");
DEFINE("_ORDER_EX发布RT_STR21","颜色");
DEFINE("_ORDER_EX发布RT_STR22","尺寸");
DEFINE("_ORDER_EX发布RT_STR23","原单价");
DEFINE("_ORDER_EX发布RT_STR24","活动类型");
DEFINE("_ORDER_EX发布RT_STR25","卡号后四码");
DEFINE("_ORDER_EX发布RT_STR26","备注栏");
DEFINE("_ORDER_EX发布RT_MSG","搜寻结果笔数过多(超过300笔)，请设置筛选条件后再做汇出");
DEFINE("_ORDER_EX发布RT_STR27","赠品");
DEFINE("_ORDER_EX发布RT_STR28","运费");
DEFINE("_ORDER_SHIPDATE_ERROR","寄送日期必须大于今天");

//后台-奖金转点数
DEFINE("_PM_EX发布RT_STR_1","会员编号");
DEFINE("_PM_EX发布RT_STR_2","会员姓名");
DEFINE("_PM_EX发布RT_STR_3","申请日期");
DEFINE("_PM_EX发布RT_STR_4","金额");
DEFINE("_PM_EX发布RT_STR_5","提领模式");
DEFINE("_PM_EX发布RT_STR_6","是否有效");
DEFINE("_PM_EX发布RT_STR_7","是否结转");
...
DEFINE("_PRODUCTS_IM发布RT_MSG1","第");
DEFINE("_PRODUCTS_IM发布RT_MSG2","列商品");
DEFINE("_PRODUCTS_IM发布RT_MSG3","部分档案无法汇入，请检查后重新上传");
DEFINE("_PRODUCTS_IM发布RT_MSG4","商品汇入完成，请进入商品页补完其他栏位与开启商品");
...
DEFINE("_EMAIL_msg14","点网络回馈点已经放入您的帐户中");
...
DEFINE("_BILL_ADDRESS_ERROR","地址1超过60个字元");
DEFINE("_BILL_ADDRESS_EMPTY","帐单地址不得为空");
DEFINE("_BILL_ADDRESS2_ERROR","地址2超过60个字元");
DEFINE("_BILL_CITY_EMPTY","帐单州属不得为空");


//补翻译
DEFINE("_MEMBER_SUCCESS_SMS","亲爱的会员，恭喜您已注册成功，欢迎您成为红崴GoodARCH会员，感谢您的加入，您可使用账号及密码，立即登录购物平台购买商品");
...
DEFINE("_MEMBER_OVERSEA_发布INTS","[海旅点数]");
...
DEFINE("_PW_ERROR_MSG","请先验证手机或邮箱");
DEFINE("_MEMBER_MOBILE","手机号码");
DEFINE("_MEMBER_ACCPW","登录密码");
DEFINE("_CODE","商品编号(国际条码)");
DEFINE("_CODE_EMPTY","商品编号(国际条码)不可为空");
?>