...
class ApiClient
{
    ...
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        // debugging for curl
		$getLogConfiguration = $this->merchantConfig->getLogConfiguration();
        if ($getLogConfiguration->isLoggingEnabled()) {
            curl_setopt($curl, CURLOPT_VERBOSE, 1);
            $tempBlowup = explode(DIRECTORY_SEPARATOR, $getLogConfiguration->getDebugLogFile());
